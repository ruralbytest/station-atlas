...
An interactive 3D model of the International Space Station built with React, Three.js, and shadcn/ui. Take NASA's "ISS complete 2011" reference apart into **382 individually selectable pieces**, explore **10 station systems**, and search **55 named modules and assemblies**. Forked from Human Atlas, the same viewer built for anatomy.
...
Validation covers mesh buffers, names and concept membership, sourced explanations for every concept, nonoverlapping exploded layouts at desktop and mobile aspect ratios, search and inspection contracts, and tap-versus-drag handling. Browser interaction checks have exercised selection, system controls, search, isolation, rotation, and 390×844, 320×568, and 844×390 layouts. Phone controls stay clear of the exploded inventory, and isolated structures fit the space above or beside the detail panel. Physical-device performance and real multitouch hardware have not been tested.
